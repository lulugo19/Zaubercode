...
const Split = (idsOption, options = {}) => {
    ...
    function drag(e) {
        ...
        // in this callback.
        getOption(options, 'onDrag', NOOP)(getSizes(), self.gutter)
    }
    ...
    function stopDragging() {
        ...
        if (self.dragging) {
            getOption(options, 'onDragEnd', NOOP)(getSizes(), self.gutter)
        }
    ...
    function startDragging(e) {
        ...
        if (!self.dragging) {
            getOption(options, 'onDragStart', NOOP)(getSizes(), self.gutter)
        }
